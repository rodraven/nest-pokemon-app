...
Pokedex API built with [NestJS](https://github.com/nestjs/nest). Exposes a REST CRUD for Pokemon under the `api/v2` global prefix and serves a static front-end from `public/`.
...
This starts MongoDB on port `27017`, persisting data to the local `mongo/` folder.
